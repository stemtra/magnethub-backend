...
export async function generateOutline(
  ...
  const typeDescriptions: Partial<Record<LeadMagnetType, string>> = {
    ...
    infographic: 'A visual infographic (not text-based). This should not be used in outline generation.',
    // uploaded types don't need AI descriptions - they're user-provided
  };
...
export async function generateContent(
  ...
  const lengthGuides: Partial<Record<LeadMagnetType, string>> = {
    ...
    infographic: 'N/A - Visual content generated by image generation service.',
    // uploaded types don't need length guides - they're user-provided
  };
  ...
  const maxOutputTokensByType: Partial<Record<LeadMagnetType, number>> = {
    ...
    casestudy: 5200,
    guide: 7000,
    infographic: 0, // N/A for infographics
    // uploaded types don't need AI token limits - they're user-provided
  };
